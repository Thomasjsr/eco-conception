    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="h-screen">
                <div className="flex justify-start items-end h-1/2 lg:h-screen md:h-1/2 bg-[url('../\src\assets\webp-images\76ebb484-c1af-4e95-a46e-853f00d41124_reportage-portraits-cuisine-salle-46.webp')] bg-cover bg-no-repeat bg-top">
                ...
                <div className="flex h-1/2 lg:h-screen md:h-1/2">
                    ...
                    <div className="w-1/2 bg-[url('../\src\assets\webp-images\b5c82a2d-5a2a-4016-8538-61502f0de152_le+clos+des+sens+juin+2022+salle-7.webp')] bg-cover">
                    </div>
                </div>
            </div>
            {/* <ModalFooter /> */}
